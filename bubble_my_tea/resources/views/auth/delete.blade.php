...
<body>
    ...
    <div class="row">
        <div class="col-md-5 mx-auto">
            <h1 class="text-center text-muted mb-3 mt-5">DELETE USER</h1>
            <p class="text-center text-muted mb-5 mt-2">Are you sure you want to delete this user?</p>
            
            <form action="{{ route('app_delete') }}" method="post" class="row g-3">
                @csrf
                @method('delete')
            ...
            <p class="text-center text-muted mt-5">Want to go back? <a href="{{ route('app_login') }}" class="create-account-link">Login</a></p>
        </div>
    </div>
</div>
